...
### 4. Data Quality Upgrades (v0.6.4) 🆕
...
| Report | Description |
|:---|:---|
| `poc/document/poc_v3_AG_Module_Validation_Report.md` | **AG 모듈 검증 리포트 v3 (최신)** |
| `poc/document/poc_v2_AG_Module_Validation_Report.md` | AG 모듈 검증 리포트 v2 (원본) |
